export const INTEROP_CENTER_ABI = [
  {
    ...
    inputs: [
      ...
      { name: "_executionAddress", type: "address", internalType: "address" },
      {
        name: "_feePaymentCallStarters",
        type: "tuple[]",
        internalType: "struct InteropCallStarter[]",
        components: [
          { name: "directCall", type: "bool", internalType: "bool" },
          { name: "nextContract", type: "address", internalType: "address" },
          { name: "data", type: "bytes", internalType: "bytes" },
          { name: "value", type: "uint256", internalType: "uint256" },
          { name: "requestedInteropCallValue", type: "uint256", internalType: "uint256" },
        ],
      },
      {
