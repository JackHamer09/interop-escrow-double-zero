...
export const ExplanationScreen: React.FC<ExplanationScreenProps> = ({ onClose }) => {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-xl overflow-auto max-h-[90vh]">
        ...
        <CardContent className="space-y-6 -mt-3">
          ...
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              Watch this video to learn more about the demo and see the cross-chain confidential trading in action
            </p>
        ...
        <CardFooter className="flex justify-end">
          <Button onClick={onClose} disabled={!prerequisitesCompleted}>
            Got it, let&apos;s start
          </Button>
        </CardFooter>
      </Card>
