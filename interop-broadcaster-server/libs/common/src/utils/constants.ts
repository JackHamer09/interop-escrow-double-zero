...
export const L2_STANDARD_TRIGGER_ACCOUNT_ADDRESS = getAddress("0x000000000000000000000000000000000001000d".toLowerCase());
export const L2_INTEROP_HANDLER_ADDRESS = getAddress("0x000000000000000000000000000000000001000B".toLowerCase());
export const L2_INTEROP_CENTER_ADDRESS = getAddress("0x000000000000000000000000000000000001000A".toLowerCase());
